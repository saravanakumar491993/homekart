...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post order_details_url, params: { order_detail: { amount: @order_detail.amount, discount: @order_detail.discount, mrp: @order_detail.mrp, order_id: @order_detail.order_id, product_id: @order_detail.product_id, quantity: @order_detail.quantity } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { amount: @order_detail.amount, discount: @order_detail.discount, mrp: @order_detail.mrp, order_id: @order_detail.order_id, product_id: @order_detail.product_id, quantity: @order_detail.quantity } }
